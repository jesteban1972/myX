...
function initializeMap() {
    ...
    */
    ...
    sessionStorage.setItem("mapCenter", "38.325707, 24.390816"); // it should come from PHP!!!
    ...
    downloadURL ('locaMapFetchXML.php', function(data) {
        ...
        for (i = 0; i < loca.length; i++) {
             ...
             */
            if (loca[i].getAttribute('coordinatesExact') !== null) {
                
                coordinates = loca[i].getAttribute('coordinatesExact');
                markerColour = 'FF0000'; // red
                
            } else if (loca[i].getAttribute('coordinatesGeneric') !== null) {
                
                coordinates = loca[i].getAttribute('coordinatesGeneric');
