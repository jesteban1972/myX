 ...
 * - praxisID
 * - locus (corresponding to field 'name' of table 'loca')
 * - date
 * - ordinal
 * - name (of table 'practica')
 * - rating (of table 'practica')
 * - description (of table 'practica')
 * - tq
 * - tl
 * - favorite
 */
    ...
    att.value = 'locus';
    option.setAttributeNode(att);
    txt = document.createTextNode('Place');
    option.appendChild(txt);
    select.appendChild(option);
    ...
    att.value = 'ordinal';
    option.setAttributeNode(att);
    txt = document.createTextNode('Ordinal');
    option.appendChild(txt);
    select.appendChild(option);
    ...
    att.value = 'tq';
    option.setAttributeNode(att);
    txt = document.createTextNode('TQ');
    option.appendChild(txt);
    select.appendChild(option);
    ...
    att.value = 'tl';
    option.setAttributeNode(att);
    txt = document.createTextNode('TL');
    option.appendChild(txt);
    select.appendChild(option);
    ...
    att.value = 'favorite';
    option.setAttributeNode(att);
    txt = document.createTextNode('Favorite');
    option.appendChild(txt);
    select.appendChild(option);
    ...
    att.value = 'praxisID';
    option.setAttributeNode(att);
    txt = document.createTextNode('Experience ID');
    option.appendChild(txt);
    select.appendChild(option);
...
function changeRuleField(evt) {
    ...
    switch (select.options[select.selectedIndex].value) {
        ...
        case 'date':
            ...
            updateRuleCriteria(ruleIndex, 'date');
            break;
        ...
        case 'favorite':
            ...
            updateRuleCriteria(ruleIndex, 'bool');
            break;
