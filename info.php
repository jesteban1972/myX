...
<p>Immediately after submitting any information, you’ll have access to your records, and you can browse through your data in a number of ways: Using a chronological list of your experiences, using an alphabetic list of your lovers, or surfing in a map with your places. You can navigate through your experiences using the Synchroton, an ingenious mechanism which allows you to surf forwards or backwards in the time according to different criteria: Next/previous experience with the same lover, chronologically or in the same place.</p>
<p>Have at a glance practical statistics about your sexual activity: How many lovers did you have yet? Which were your best experiences? How many experiences you had in a given year? How was the evolution of my sexual activity yearly? and much, much more. You can query your data to get personalized queries (ex.: Which were my best experiences in a determinate place in a determinate time span). You can save your personalized queries and they will be dynamically updated.</p>
<p>There’s no need to be a famous libertine to use myX. It’s a practical tool for anyone having an active sexual life, from the extreme promiscuity to any old-fashion, monogamic behavour.</p>
<p>Create now your free myX account, enjoy having sex… and enjoy remembering it!<br />
Your myX team.</p>
HTML;
